...
/**
 * TAddressesId generated by hbm2java
 */
@Embeddable
public class TAddressesId implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6023710063327274407L;
	...
	public TAddressesId(int id, int TPeopleId) {
		this.id = id;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TAddressesId))
			return false;
		TAddressesId castOther = (TAddressesId) other;
