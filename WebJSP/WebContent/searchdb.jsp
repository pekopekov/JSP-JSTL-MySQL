...
<html>
    ...
    <body>
        ...
        <sql:query dataSource="${dbsource}" var="result">    
			...
			INNER JOIN T_ADDRESSES  AS o ON p.id  = o.T_PEOPLE_ID WHERE lower(FULL_NAME) = ?;
            ...
            <table border="1" width="40%">
                ...
                <c:forEach var="row" items="${result.rows}">
                    <tr>
                        ...
                        <td><a href="javascript:confirm('Delete this record?','delete.jsp?id=<c:out value="${row.id}"/>')">Delete</a></td>
                    </tr>
                </c:forEach>
            </table>
        </form>
